...
default_wordlist = r'C:\YOU-WORDLIST-PATH-HERE'  #  Paste your wordlist path, including the wordlist name and format.

timeout_duration = 95  # (Seconds)
...
if not os.path.isfile(wordlist):
    ...
    with open(wordlist, 'r', encoding="latin-1") as f:
        ...
        def main():
                while True:
                    hash_str, salt = "", ""
                    hash_str = input(f" {Fore.RESET}[{Fore.LIGHTMAGENTA_EX}»{Fore.RESET}] {Fore.RESET}Enter {xhash}: {Fore.RESET}")
                    print()
                    salt = input(f" {Fore.RESET}[{Fore.LIGHTMAGENTA_EX}»{Fore.RESET}] {Fore.RESET}Enter salt{Fore.LIGHTBLACK_EX} (optional): {Fore.RESET}")
                    os.system("cls || clear")
                    print()
                    printcenter(f"{Fore.CYAN}{logo}")
                    print()
                    print(f" {Fore.RESET}[{Fore.CYAN}#{Fore.RESET}] Hash:{Fore.LIGHTBLACK_EX} {hash_str}")
                    print()
                    print(f" {Fore.RESET}[{Fore.CYAN}#{Fore.RESET}] Salt:{Fore.LIGHTBLACK_EX} {salt}")
                    print()
                    print()
                    print()
                    print(f" {Fore.RESET}[{Fore.CYAN}#{Fore.RESET}] {Fore.LIGHTMAGENTA_EX}Decrypting...")
                    startTime = time.time()
                    ...
                    if final is None:
                        ...
                        printcenter(f"{Fore.CYAN}{logo}")
                        print()
                        print(f"{Fore.LIGHTBLACK_EX}It was not possible to decrypt the last hash. ({totalTime} seconds.)")
                        print()
                        print()
                        main()
                    else:
                        ...
                        print()
                        print(f" {Fore.RESET}[{Fore.CYAN}#{Fore.RESET}] Hash successfully decrypted! {Fore.LIGHTBLACK_EX}{hash_str}")
                        print()
